...
add_action('after_setup_theme', 'centerfitness_setup');

function centerfitness_menus() {
    register_nav_menus( array(
        'menu-principal' => __('Menu Principal', 'centerfitness')
    ) );
}

add_action('init', 'centerfitness_menus');

function centerfitness_scripts_styles() {
    // Archivos CSS
...
add_action('wp_enqueue_scripts', 'centerfitness_scripts_styles');

// Definir zona de widgets
function centerfitness_widgets() {
...
add_action('widgets_init', 'centerfitness_widgets');


// Crear Shortcode
function centerfitness_ubicacion_shortcode(){
    ?>
    <div class="mapa">
        <?php
            if(is_page('contacto')) {
...
add_shortcode('centerfitness_ubicacion', 'centerfitness_ubicacion_shortcode');

/** Imagenes dinamicas como BG */
function centerfitness_hero_imagen() {
...
add_action('init', 'centerfitness_hero_imagen');